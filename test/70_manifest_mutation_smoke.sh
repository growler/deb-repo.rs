...
assert_manifest_contains "# ubuntu archive"
assert_manifest_contains "https://archive.ubuntu.com/ubuntu/"
...
assert_manifest_contains "# desktop tooling"
assert_manifest_contains "\"curl\""

run_case_expect_ok "forbid_comment" forbid -c "systemd guard" 'systemd (<< 255)'
assert_manifest_contains "# systemd guard"
assert_manifest_contains "\"systemd (<< 255)\""
...
assert_manifest_contains "# notice artifact"
assert_manifest_contains "/etc/mutation/notice.txt"

run_case_expect_ok "stage_comment" stage -c "stage note" ./note.txt
assert_manifest_contains "# stage note"
assert_manifest_contains "\"./note.txt\""
...
assert_manifest_contains "# local package"
assert_manifest_contains "${PKG_NAME}"
