...
run_case_expect_ok "edit_env" edit --editor ./write-env.sh env
assert_manifest_contains "EDITOR_VALUE = \"from-editor\""

run_case_expect_ok "edit_script" edit --editor ./write-script.sh script
assert_manifest_contains "/opt/edit/script.txt"

run_case_expect_ok \
    "edit_artifact" \
    edit --editor ./write-artifact.sh artifact notice.txt --target /etc/edit/notice.txt --stage
...
run_case_expect_fail "edit_env_invalid" edit --editor ./write-invalid-env.sh env
